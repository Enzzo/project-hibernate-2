...
import ru.javarush.vasilev.dao.*;
import ru.javarush.vasilev.domain.*;
...
public class App{
    ...
    public App(){
        ...
        props.put(Environment.URL, "jdbc:p6spy:mysql://localhost:3307/movie");
...
//        app.customerRentInventory(customer);
    ...
    private Customer createCustomer() {
        try(Session session = sessionFactory.getCurrentSession()){
            ...
            customer.setEmail("kragujevac@gmail.com");
